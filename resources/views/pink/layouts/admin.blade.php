<!DOCTYPE html>
    ...
    <body class="no_js responsive {{ (Route::currentRouteName() == 'home') ? 'page-template-home-php' : ''}} stretched  backgroundadmin">
        ...
        <div class="bg-shadow">
            ...
            <div id="wrapper" class="group">
                ...
                <div id="header" class="group">
                    ...
                    <div class="group inner background">
                        
                        <!-- START LOGO -->
                        <div id="logo" class="group">
                            <a href="/" title="Test site"><img src="{{ asset(env('THEME')) }}/images/logo.png" title="Test site" alt="Test site" /></a>
                        </div>
                        <!-- END LOGO -->
