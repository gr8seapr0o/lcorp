<div id="content-single" class="content group">
    ...
    <!-- START TRACKBACK & PINGBACK -->
        ...
        <div id="respond">
            <h3 id="reply-title">Оставить ответ <span>{{Lang::get('ru.reply')}}</span>
                <small><a rel="nofollow" id="cancel-comment-reply-link" href="#respond" style="display:none;">
                        {{Lang::get('ru.cancel_replay')}}</a></small>
            </h3>
            <form action="{{ route('comment.store') }}" method="post" id="commentform">
                ...
                <p class="comment-form-comment"><label for="comment">{{Lang::get('ru.Your_comment')}}</label><textarea
                            id="comment" name="text" cols="45" rows="8"></textarea></p>
                <div class="clear"></div>
                <p class="form-submit">
