...
<![endif]-->
    ...
    <!-- START BODY -->
    <body class="no_js responsive {{ (Route::currentRouteName() ==  'home') || (Route::currentRouteName() == 'portfolios.index') || (Route::currentRouteName() == 'portfolios.show')  ? 'page-template-home-php' : ''}} stretched {{ Route::currentRouteName() =='login' ? 'background' : '' }}">
        ...
        <!-- START BG SHADOW -->
            ...
            <div id="wrapper" class="group">
                ...
                <div id="header" class="group" style="{{ Route::currentRouteName() =='login' ? 'background-color: gainsboro' : '' }};">

                    <div class="group inner">
                        
                        <!-- START LOGO -->
                        <div id="logo" class="group">
                            <a href="/" title="esperanto"><img src="{{ asset(env('THEME')) }}/images/superman.png" title="тест сайт" alt="" /></a>
                        </div>
                        <!-- END LOGO -->
                ...
                <!-- START SLIDER -->
					...
					<div id="page-meta">
					    <div class="inner group">
					        <h3>Добро пожаловать на страницу моего портфолио</h3>
					        <h4>... надеюсь Вам понравятся мои работы</h4>
					    </div>
					</div>
					<!-- END PAGE META -->
					@endif
